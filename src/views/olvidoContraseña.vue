<template>
  ...
  import supabase from '../supabase'; // Asegúrate de que la configuración de Supabase esté correcta
    ...
    setup() {
      ...
      const resetPassword = async () => {
        ...
        try {
          ...
          // Enviar solicitud de recuperación de contraseña a través de Supabase
      ...
      // Función para redirigir de vuelta a la página de inicio de sesión
      const goBackToLogin = () => {
        router.push('/login'); // Redirigir al componente de inicio de sesión
      };
